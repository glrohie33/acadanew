							...
							<div class="wm-search-course">
                                ...
                                <form>
                                    <ul>
                                        ...
                                        <li class="search"> <input type="text" list="hints" placeholder="Search For course" v-model="search" @blur="hints=[]" @keypress="hint()"> <i class="wmicon-search"></i>
                                            <datalist v-if="cat == 'institutions'" class="hints" id="hints">
                                                <option  v-for="(x,index) in hints"  :key="index" :value="x.fullName.toLowerCase()">{{x.fullName}}</option>
                                            </datalist>

                                            <datalist v-if="cat == 'courses'" class="hints" id="hints">
                                                <option style="padding:10px; font-weight:bold;"  v-for="(x,index) in hints"  :key="index" :value="x.name.toLowerCase()">{{x.name}}</option>
                                            </datalist>
                                        </li>

                                        <li><div class="wm-apply-select">
                                            <select v-model="cat">
                                        ...
                                        <li> <input type="button" value="Search course" @click="searchCourse()"> </li>
                                    </ul>
                                </form>
                            </div>
						</div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-9 wm-top-spacer">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-12">
                                    <VueSlickCarousel class="wm-event-latest-slider" v-bind="eventBanner">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <VueSlickCarousel v-bind="testimonial">
                                ...
                                <template slot="prevArrow" #prevArrow="arrowOptions"  >
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <VueSlickCarousel class="wm-partners-slider gallery"  v-bind="partners">
                            ...
                            <div class="wm-contact-tab">
                              ...
                              <div class="tab-content">
                                <div class="tab-pane active" id="home">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12"> <div class="wm-map"> <div id="map"></div> </div> </div>
                                        <div class="col-md-8 col-sm-12">
...
export default {
  ...
  data() {
    return {
      ...
      arrowOption:{
          prev:"<span class='slick-arrow-left'><i class='wmicon-arrows'></i></span>"
      },
      settings2: {
        slidesToShow: 3,
        slidesToScroll: 1,
        asNavFor: this.$refs.B1,
        dots: false,
        vertical: true,
        centerMode: false,
        focusOnSelect: true
  ...
  created(){
       this.nav = document.getElementsByClassName("slick-arrow");
  },
  methods:{
        searchCourse(){
            this.errors = [];
...
<style lang="scss" >
.wm-fancy-title, .wm-simple-title{
    float:none;
}
...
.wm-history-list::-webkit-scrollbar{
    
    border-radius: 5px;
    background: rgb(90, 97, 125);
}

.wm-history-list::-webkit-scrollbar-thumb{
    background:rgb(166, 171, 193);
}
